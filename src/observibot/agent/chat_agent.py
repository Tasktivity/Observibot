...
from observibot.agent.prompt_utils import (
    log_prompt_size as _log_prompt_size,
)
from observibot.agent.prompt_utils import (
...
# PROMPT_WARN_TOKENS / PROMPT_ERROR_TOKENS and the _estimate_tokens /
# _enforce_budget / _log_prompt_size / _sample_rows helpers now live in
# :mod:`observibot.agent.prompt_utils` so they can be shared with the
# monitor path. The underscore aliases imported above preserve the
